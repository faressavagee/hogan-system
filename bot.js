...
const voiceChannel = '599246692159586314'; 
...
client.on('ready', () => {
client.channels.get(voiceChannel).setName(`NORMANDY Voice: [${membersSize(client)}]`)
}); 
...
setInterval(function(){})
  ...
  client.on('message', msg => {//msg
    if (msg.content === 'الوان') {
      msg.channel.send({file : "https://cdn.discordapp.com/attachments/579101020672491541/594349098229039134/colors.png"})
    }
  });
  client.on('message', msg => {//msg
...
client.on('message', msg => {
  if(msg.content === 'هوجان')
              setTimeout(function() {  
msg.reply('**انت بتنادي ليه يا ولا انت جلنط**')
              }, 00)
});


client.on("guildMemberAdd", member => { 
        if(member.guild.id === "537966671810527235") { 
setTimeout(function(){ 
